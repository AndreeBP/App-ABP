package com.example.mapainfowindow;
...
//libreria supiuestamente del BottomSheet
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback , GoogleMap.OnMarkerClickListener {
    ...
    private void ObtenerPuntos() {
        ...
        class getResult extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequest("http://localhost:8080/products");// SEDES
                return s;
            }
        }
    ...
    private void CargarPuntosAMapa() {
        ...
        if (listaPuntos.size() > 0) {
            ...
            Toast.makeText(this, "Lo sentimos, no hay informacion de la ubicación seleccionada", Toast.LENGTH_SHORT).show();
        }
